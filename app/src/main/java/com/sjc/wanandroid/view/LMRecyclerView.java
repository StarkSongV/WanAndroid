...
public class LMRecyclerView extends RecyclerView {
     ...
     * @param footerResId
     */
    private void showFooterStatus(int footerResId) {
    ...
    private class BaseAdapter extends Adapter<CommonRVViewHolder> {
        ...
        public CommonRVViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == VIEW_TYPE_HEADER)
                return CommonRVViewHolder.createViewHolder(mHeaderView);
            if (viewType == VIEW_TYPE_FOOTER)
                return CommonRVViewHolder.createViewHolder(parent, R.layout.item_root_footer);
            return (CommonRVViewHolder) mAdapter.onCreateViewHolder(parent, viewType);
        }
     ...
     * @param holder
     */
    private void showFooterView(CommonRVViewHolder holder) {
    ...
    public void showLoadMore() {
        if (footerResId == R.layout.item_footer_loading_more) {
            return;
        }
     ...
     */
    private void setIsReClickLoadMore(boolean isReClickLoadMore) {
